...
import { createCategoryAction, updateCategoryAction } from "@/modules/products/actions";
...
export default function CategoryForm({ category }: { category: any }) {
  ...
  const [state, formAction] = useActionState(isNew ? createCategoryAction : updateCategoryAction, null);
  ...
  return (
    <Card>
      ...
      <CardContent>
        <form action={formAction} id="category-form" className="space-y-4 max-w-xl">
